...
class Developer : public Employee {
 public:
  ...
  void SetSalary(float salary) override { _salary = salary; }

  float GetSalary() override { return _salary; }
...
class Organization {
 public:
  explicit Organization(size_t size) : _size(size) {}
  ...
  size_t GetEmployeeSize() { return _size; }
