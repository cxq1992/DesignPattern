...
might get a wooden door from a wooden door shop, iron door from an iron shop or
a PVC door from the relevant shop. Plus you might need a guy with different kind
of specialities to fit the door, for example a carpenter for wooden door, welder
...
class Welder : public DoorFittingExpert {
 public:
  ...
  virtual void GetDescription() { std::cout << "I'm a welder." << std::endl; }
};
